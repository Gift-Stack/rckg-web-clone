...
export interface ChartContainerProps {
	...
	// toolbar_bg: ChartingLibraryWidgetOptions["toolbar_bg"];
}
...
const exchangeBaseUrl = process.env.NEXT_PUBLIC_EXCHANGE_BASEURL as string;
...
> {
	public static defaultProps: ChartContainerProps = {
		...
		datafeedUrl: `${exchangeBaseUrl}UDF`,
	...
	public componentDidUpdate(prevProps: any) {
		this.tvWidget = this.tvWidget;
		if (prevProps.symbol !== this.props.symbol) {
			this?.tvWidget?.applyOverrides(this.widgetOptions);
			const forceRender = new widget({
				...this.widgetOptions,
				symbol: this.props.symbol,
			});
			this.tvWidget = forceRender;
			if (this.tvWidget !== null) {
				this.tvWidget = null;
			}
		}
