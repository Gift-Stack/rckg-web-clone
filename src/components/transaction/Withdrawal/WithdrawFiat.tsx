...
import { WithdrawFiatProps } from "./model";

const WithdrawFiat: FC<WithdrawFiatProps> = ({
	...
	return (
		<div data-testid={"transaction-withdraw-fiat"}>
			<div className={"mt-2"}>
				<TransactionSelect
			...
			<div className={"mt-5"}>
				...
				<div className={"text-left w-full flex justify-center"}>
					...
					>
						...
						<div
							data-testid={"transaction-withdraw-fiat-radio"}
